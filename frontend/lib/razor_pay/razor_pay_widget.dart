...
class PaymentService {
  ...
  static final String baseUrl = 'http://127.0.0.1:8002/api';
  ...
  static Future<Map<String, dynamic>> createOrder({
    ...
    try {
      print('Creating order with amount: $amount, category: $category');
  ...
  static Future<Map<String, dynamic>> verifyPayment({
    ...
    try {
      print('Verifying payment with paymentId: $paymentId, orderId: $orderId');
      final response = await http.post(
...
class _PaymentFeatureScreenState extends State<PaymentFeatureScreen> {
  ...
  Future<void> _initiatePayment() async {
    ...
    try {
      ...
      print('Initiating payment with amount: ${_amountController.text}');
      ...
      print('Order created: orderId=$orderId, keyId=$keyId');
      ...
      // Add UPI specific options if required
...
class _PaymentHistoryScreenState extends State<PaymentHistoryScreen> {
  ...
  Future<void> _fetchPaymentHistory() async {
    try {
      ...
      print('Payment history fetched: $_payments');
    } catch (e) {
      setState(() => _isLoading = false);
