...
class _AccountDisplayWidgetState extends State<AccountDisplayWidget> {
  ...
  Future<void> _fetchAccountDetails() async {
    ...
    const String accountApiUrl = "http://127.0.0.1:8000/api/account_details/";
    const String expenseApiUrl = "http://127.0.0.1:8000/api/monthly_expense/";
  ...
  Future<bool> _verifyPin(String enteredPin) async {
    ...
    const String verifyPinUrl = "http://127.0.0.1:8000/api/verify_pin/";
    try {
